...
type ClipFileReq struct {
	...
	Hash    string `protobuf:"bytes,3,opt,name=Hash,proto3" json:"Hash,omitempty" form:"hash"`
}
...
type ClipResp struct {
	...
	Board   []*Clip `protobuf:"bytes,2,rep,name=Board,proto3" json:"Board,omitempty" form:"Board" query:"Board"`
}
